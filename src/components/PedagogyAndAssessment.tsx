    ...
    return (
        <section className="bg-white overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row min-h-[700px]">
                ...
                <div className="lg:w-1/2 bg-[#0A0A0A] p-16 lg:p-24 space-y-16 relative">
                    ...
                    <div className="space-y-6 max-w-md">
                        <div className="bg-[#121212] p-10 rounded-2xl space-y-6 border border-white/5">
                    ...
                    {/* Decorator text on left side as seen in image */}
                    <div className="absolute bottom-10 left-10 pointer-events-none pb-4">
                        <p className="text-[10px] font-bold text-gray-800 uppercase vertical-text tracking-[1em]">XXXX XXXX XXXX</p>
                    </div>
                </div>
                ...
                <div className="lg:w-1/2 bg-brand-blue p-16 lg:p-24 space-y-16 text-white relative">
                    ...
                    <div className="space-y-4 max-w-md">
                        {[
                            ...
                            <div key={idx} className="bg-white p-8 rounded-3xl space-y-4 shadow-xl shadow-brand-blue/10 group hover:scale-[1.02] transition-all cursor-default">
                                <h4 className="text-brand-blue font-bold text-xl leading-tight font-outfit tracking-tight">{item.title}</h4>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 space-y-24">
                ...
                <div className="flex flex-col lg:flex-row gap-20 items-center">
                    ...
                    <div className="lg:w-1/2 w-full">
                        <div className="relative rounded-[3rem] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] aspect-[4/3]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={idx} className="bg-white p-12 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col justify-between h-[360px] group hover:border-brand-blue/30 hover:shadow-xl hover:shadow-brand-blue/5 transition-all relative">
                            <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-brand-blue/20 rounded-tl-2xl group-hover:border-brand-blue transition-colors" />
                            <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-brand-blue/20 rounded-br-2xl group-hover:border-brand-blue transition-colors" />

                            <p className="text-brand-blue font-black text-2xl tracking-tight">{item.step}</p>
